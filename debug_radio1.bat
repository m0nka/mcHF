...
"C:\Program Files (x86)\BEL\Realterm\realterm.exe" baud=115200 port=9 rows=55 colors=RYLRYK scrollback=5000 fontname="Lucida Console" fontsize=16 capfile="%~dp0claude\uart\uart1_%ts%.log" capsecs=86400 capdirect=0 capture
