...
**  Description:     BQ40Z80 gold file backup/flash (bootloader variant)           **
**  Last Modified:                                                                 **
...
#define BMS_GOLD_ERR_SD_INIT        13
#define BMS_GOLD_ERR_FS_INIT        14

// Bootloader entry points (use HAL_Delay, no RTOS)
