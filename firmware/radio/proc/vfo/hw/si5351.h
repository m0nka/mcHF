...
#define SI5351_BUS_BASE_ADDR            192	//0x60
...
//  Si5351(uint8_t i2c_addr = SI5351_BUS_BASE_ADDR);
	...
	uint8_t Si5351_si5351_write_bulk(uint8_t, uint8_t, uint8_t *);
	uint8_t Si5351_si5351_write(uint8_t, uint8_t);
	uint8_t Si5351_si5351_read(uint8_t);
...
//private:
	uint64_t Si5351_pll_calc(enum si5351_pll, uint64_t, struct Si5351RegSet *, int32_t, uint8_t);
