#ifndef __FT8_CONSTANTS_H
#define __FT8_CONSTANTS_H
...
#define FT8_N					174 			 	// Number of bits in the encoded message
...
#define CRC_POLYNOMIAL 			0x2757  			// CRC-14 polynomial without the leading (MSB) 1
#define CRC_WIDTH 				14
